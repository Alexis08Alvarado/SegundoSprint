...
Get-VM | Where-Object {$_.Notes -like "*103107*"} | Select-Object  @{ expression={$_.Name}; label='VM' }, PowerState, @{N="DnsName"; E={$_.ExtensionData.Guest.Hostname}}, @{ expression={$_.NumCpu}; label='CPUs' }, MemoryGB | ConvertTo-Csv 
